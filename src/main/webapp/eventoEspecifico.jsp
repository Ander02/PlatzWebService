        ...
        <div class="row">     
            ...
            <div class="jumbotron caixa-informacao-especifico">
                ...
                <div class="col-md-12 informacao-evento-especifico">
                    ...
                    <div class="col-md-3">  <h1>Nome do Evento</h1> </div>
                    ...
                    <div class="col-md-12">    
                        ...
                        <h3><a href="perfilEmpresa.html">Nome da Empresa</a></h3>
                ...
                <div class="excerpt">
                    <div class="info-especifico">
                        <div class="col-md-6">
                            <h3>Informações</h3>
                            <p>Data Inicio 02/02/02 as 00:00 , Data Termino 02/02/02 as 00:00</p>
                            <hr/> 
                            <p>Lotação Minima: 252 , Lotação Maxima: 1000</p>
                            <hr/>
                            <p>Preço: R$100,00</p>
                        </div>
                        <div class="col-md-6">
                            <h3>Endereço</h3>
                            <p>Rua: Soriano de Albuquerque , Numero: 416 , CEP: 05894440</p>
                            <hr/>
                            <p>Cidade: São Paulo , Bairro: Jardim sete lagos</p>
                            <hr/>
                            <p>Complemento: lalaalalal</p>
                        </div>
                    </div>
